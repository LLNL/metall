...
/// \brief A string container that uses char as its character type and Metall as its default allocator.
using string = basic_string<char>;

/// \brief A string container that uses wchar_t as its character type and Metall as its default allocator.
