...
// This is an example of container of containers (or multi-level containers) with Metall
...
int main() {

  {
    ...
    // the inner vectors obtain their allocator arguments from the outer vector's scoped_allocator_adaptor
