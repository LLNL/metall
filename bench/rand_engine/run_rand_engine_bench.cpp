...
int main() {
  ...
  std::cout << "std::mt19937_64  \t" << run_bench<std::mt19937_64>(num_generate) << std::endl;
  std::cout << "boost::mt19937_64\t" << run_bench<boost::random::mt19937_64>(num_generate) << std::endl;
  std::cout << "xoshiro512++     \t" << run_bench<metall::utility::rand_512>(num_generate) << std::endl;
  std::cout << "xoshiro1024++    \t" << run_bench<metall::utility::rand_1024>(num_generate) << std::endl;
