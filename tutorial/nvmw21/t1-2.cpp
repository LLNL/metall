...
// This program allocates a user-defined struct/class object and reattaches it using Metall.
// One can learn how non-primitive data type object is constructed and destructed with Metall.
