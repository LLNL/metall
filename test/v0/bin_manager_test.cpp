...
TEST(BinManagerTest, ToLargeBinNo) {
  ...
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size - 1), bin_no_mngr::num_small_bins());
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size), bin_no_mngr::num_small_bins());
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size + 1), bin_no_mngr::num_small_bins() + 1);

  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size * 2 - 1), bin_no_mngr::num_small_bins() + 1);
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size * 2), bin_no_mngr::num_small_bins() + 1);
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size * 2 + 1), bin_no_mngr::num_small_bins() + 2);

  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size * 3 - 1), bin_no_mngr::num_small_bins() + 2);
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size * 3), bin_no_mngr::num_small_bins() + 2);
  ASSERT_EQ(bin_no_mngr::to_bin_no(k_chunk_size * 3 + 1), bin_no_mngr::num_small_bins() + 2);
